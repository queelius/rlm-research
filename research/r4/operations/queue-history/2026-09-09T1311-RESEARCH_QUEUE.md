...
Updated September 9, 2026, 13:11 UTC. MAIN owns GPU launches and cleanup.
[Previous state](2026-09-09T1250-RESEARCH_QUEUE.md).
...
Two real, accepted successor processes now wait in sequence behind active Qwen144.
...
|---|---|
| ACTIVE: released-model identity144 | after-adaptive-rlvr-qwen144, PTY40783, parent3814686/start1075976013. PLAN4862b4b0…/ACCEPTANCEe528a2b9…,915paths; READYc62c85a4…. Qwen3-4B-Instruct2507 versus Qwen3.5-4B, no research adapters;12 exposed contexts×two freshseeds×plain/matching/constant×two models.2400work/2640owned/2670outer. Actual commandstart1788958885.619105 (13:01:25.619); Qwen3 first72 calls completed13:09, second-model service starting. Qwen3.5 A100 kernels remain unqualified until actual service/calls. Independent audit method written before outcomes. |
| ACCEPTED WAITING NEXT1: equal-row SFT+48 | after-qwen144-rowmean-sft, PTY60160, parent3889815/start1076170023; waiting12:44:47.647. PLAN450027d1…/ACCEPTANCE42aafb02…,1060paths; READY475cbdf3…/identity48a7c10f…. Same32rows/start473210/seed/order/fourupdates; change only normalization to equal-row loss. Fixedfinal4 versus frozen original token-weighted efab2913;48 new paired readouts on exposed clusters.3330outer/3300owned; conservative predecessor-plan envelope1788966451.9795966. MAIN fresh6native+3tinyLoRA tests and verify passed. |
| ACCEPTED WAITING NEXT2: sparse reminder order96 | after-rowmean-sft-cue96, PTY78123, parent3899690/start1076191190; waiting12:48:19.314. PLAN898a5be5…/ACCEPTANCE8b3f3903…,1088paths; READY8818fd43…. Cadence4, matching/constant×tag-first/label-first;12 exposedcontexts/two freshseeds, fixedc32.48 physical prompt pairs exactly equal; only ordered decoder schema changes within order pairs.600collection/780work/900owned/930outer. Primary tests whether benefit shifts toward next label; no internal-attention claim. MAIN12fresh tests/verify passed. |
| CPU IMPLEMENTATION NEXT3: complete-success SFT+shared readout72 | New root-success-trajectory-sft-v1.27 confirmed training-only successful/recovery trajectories,114 physical turns/15,256targets; exactefab start/freshAdam/eight full-corpus updates/LR2e−5/equalepisode→turn→token loss.216episode exposures/122,048targets. MAIN approved additive3-arm readout: baselineefab, SFTfixed8, last-savedRL7 on24shared fresh coordinates. RL7 is newly evaluated after its STOP, not original final8.4530outer/4500owned/4380work/1200training/900eachcollection. No GPU acceptance yet. |
| CPU IMPLEMENTATION NEXT4: automatic accumulation ledger16 | New root-accumulation-ledger-v1, four exposed global tasks/twofreshseeds/map-only versus appended supervisor-owned all-six-label histogram+coverage. Fixedefab+c32. Preserve original tool truncation, append bounded summary before actual graph/native capture; dedup equal IDs, quarantine conflicts, no gold/target lookup/autoanswer. Whole-RLM free policy, not supplied-plan likelihood.1800outer/1770owned/1650work/1200collection. MAIN design approved; CPU fixtures/READY pending. |

Only the Qwen144 operation currently owns the GPU. Root runs share the qualified private local
