...
def binding():
    ...
    value['batch_granularity']=dict(scientific_role='leaf_base_vs_c32',frozen_child='c32',root_calls=0,planned=152)
    return value
...
PRIOR=SIDE/'leaf-c32-batch-granularity-v1'
