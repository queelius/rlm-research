...
class AdapterTests(unittest.TestCase):
    def test_only_root_checkpoint_binding_changes_and_coordinates_are_exact(self):
        ...
        self.assertEqual(b['models'][alias]['adapter_sha256'],'2286be3f7c0c9cc0e22c8ef8e3473b7d8eb6ec4b7a789ca380a0af9d3b944c71')
    ...
    def test_actual_executable_imports_and_native_root_child_route(self):
        ...
        role=s.load('rl4_actual_native_route',s.SIDE/'leaf-role-routing-v1/source/routing.py','8575081694a6ceea8d5f4058d4f625eb81d34f617a680f94bc06968e3a3ca78f')
