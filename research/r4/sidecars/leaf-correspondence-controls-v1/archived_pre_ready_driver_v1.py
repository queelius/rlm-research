...
def build_spec(comparison: str) -> dict:
    ...
    design = {
        ...
        "contract": json.loads((SIDE / "trec-leaf-contract-probe-v1/CONTRACT.json").read_text()),
...
def score_coordinate(design: dict, coordinate: dict, records: list[dict]) -> dict:
    ...
    qualification = json.loads((ROOT / "CPU_QUALIFICATION.json").read_text())
...
def main():
    ...
    if args.command == "design":
        ...
        frozen = args.frozen_spec or ROOT / ("SPEC-" + args.comparison.upper() + ".json")
