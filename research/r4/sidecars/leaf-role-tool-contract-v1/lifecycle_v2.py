"""Bind the qualified ownership lifecycle to the corrected leaf-local base wrapper."""
...
SERVICE = s.ROOT / "service_wrapper_v4.py"
...
def install(suite):
    ...
    exec(compile(claim_source(), str(SOURCE) + ":leaf-role-wrapper-v4", "exec"),
         suite.life.__dict__)
