...
math=study.load('fixedbaseline_existing_token_math',study.PRIOR/'math_core.py')
old={n:sys.modules.get(n) for n in ('study','math_core')}
sys.modules.update(study=study,math_core=math)
try:scorer=study.load('fixedbaseline_existing_selected_scorer',study.PRIOR/'trainer.py')
finally:
