import study
def test_fixed_eight_calls_and_checkpoint_native_template():
    ...
    decoded=study.tokenizer().decode(body['token_ids'],skip_special_tokens=False)
    assert decoded.endswith('<|im_start|>assistant\n<think>\n\n</think>\n\n') and 'Output-contract clarification:' in prompt
