...
class CollectorTests(unittest.TestCase):
    def test_actual_entry_retains_all24_failed_roots_without_any_acquisition(self):
        import httpx
        import collect as c
        import native as n
        ...
        with tempfile.TemporaryDirectory(prefix='record-interface-collector-') as directory:
            ...
            self.assertEqual(status['recorded'],24)
            ...
            self.assertEqual(len(original_read(args.output/'PLANNED_NULL_ENDPOINTS.json')),24)
