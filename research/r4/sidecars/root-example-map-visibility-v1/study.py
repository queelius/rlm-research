"""Pinned existing native runtime, new example/map visibility task only."""
import functools
import hashlib
...
def source():
    return load('visibility_complete_source', SOURCE / 'study.py',
...
def binding():
    prior = load('visibility_rl4_binding_source', RL4 / 'study.py',
