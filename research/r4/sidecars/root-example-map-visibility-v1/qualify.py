...
if __name__ == '__main__':
    ...
    evidence = dict(command=command, returncode=result.returncode, stdout=result.stdout, stderr=result.stderr,
                    ...
                    earlier_red='4 missing protocol/metrics implementation failures followed by 4 passes;3 missing owner implementation failures; native boundary tests added before task implementation')
