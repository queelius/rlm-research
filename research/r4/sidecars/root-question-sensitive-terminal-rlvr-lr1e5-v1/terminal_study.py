"""Exact QS6 fresh start and isolated LR1e-5 terminal-RLVR identity."""
import hashlib
...
SPARSE = SIDE / "root-composed-rl-sparse-head-recovery-v1"
BASELINE = SOURCE / "outputs/attempt-003/readout-start/export"
...
CAMPAIGN_ID = hashlib.sha256(b"root-question-sensitive-terminal-rlvr-lr1e5-v1|QS6|freshAdam0|composed48x4|fixed8|lr1e-5|attempt2-start-binding-repair").hexdigest()
SEED = 990731000
