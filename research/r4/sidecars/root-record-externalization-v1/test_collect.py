...
class CollectorTests(unittest.TestCase):
    def test_actual_entry_retains_all16_failed_roots_without_any_acquisition(self):
        import httpx
        import collect as c
        import native as n
        ...
        with tempfile.TemporaryDirectory(prefix='record-externalization-collector-') as directory:
            ...
            self.assertEqual(status['recorded'],16)
            ...
            self.assertEqual(len(original_read(args.output/'PLANNED_NULL_ENDPOINTS.json')),16)
