"""Accepted native science and terminal hooks; no extra T1/decoding modifications."""
import argparse
import asyncio
from pathlib import Path
import checkpoint
import study
adapter=study.bound('fresh8_dose_eval_collector',study.PRIOR/'collect.py',study=study,checkpoint=checkpoint)
