"""Additive owner binding to the actual long owner defining module."""
...
try:
    spec=importlib.util.spec_from_loader('balanced32_owner_v2_source',loader=None);source=importlib.util.module_from_spec(spec);source.__file__=str(SOURCE)+':balanced32-v2';exec(compile(text,source.__file__,'exec'),source.__dict__)
finally:
