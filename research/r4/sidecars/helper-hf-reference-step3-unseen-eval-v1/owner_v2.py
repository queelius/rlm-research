"""Run the collector-interface-corrected reference checkpoint-3 readout."""
...
def build():
    spec = importlib.util.spec_from_file_location("reference_step3_v2_collector", study.C32 / "owner.py")
    ...
    def summarize(calls, gold, expected=True):
        ...
        result.update(schema="helper-hf-reference-step3-unseen-result-v2",
