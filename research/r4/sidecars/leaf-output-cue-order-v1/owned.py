"""One48-call source-cue study using private bounded qualified single-LoRA lifecycle."""
import ast
import hashlib
...
EDITS=[('identity_counter','output_cue_order',5),('96','48',2),('1080','780',1),('1200','900',3),
...
exec(compile(source,str(SOURCE_PATH)+':cue48-private','exec'),globals())
