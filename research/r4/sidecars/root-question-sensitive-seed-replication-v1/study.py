"""Fresh paired readout; original questions and exact checkpoint pair unchanged."""
import functools
...
def build_plan(rows):
    ...
    for i,row in enumerate(rows):
        value={**row,'namespace':ROOT.name,'seed':987621001+i,'repeat':1,
               'context_window_id':row['context_window_id']+2000000}
