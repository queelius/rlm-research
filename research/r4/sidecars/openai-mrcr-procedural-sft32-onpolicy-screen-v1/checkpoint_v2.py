"""V2 import binding for the unchanged authenticated checkpoint32 receipt."""
...
try:
    spec = importlib.util.spec_from_file_location("sft32_onpolicy_v1_checkpoint_for_v2", ROOT / "checkpoint.py")
