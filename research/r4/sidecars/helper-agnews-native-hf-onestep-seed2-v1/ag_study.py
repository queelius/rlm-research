...
source_study = load("ag_native_hf_seed1_study", SOURCE / "ag_study.py")
...
def plan():
    return {
        "schema": "agnews-native-hf-one-update-seed2-ready-v1",
        ...
        "seeds": {
            "namespace": "agnews-b4-native-hf-step1-seed2|20260912",
            "native_first": 202609127000,
            "native_last": 202609127127,
            "hf": SEED,
            "numpy_legacy": SEED % (2**32),
        },
        "schedule_sha256": digest(schedule()),
        "replication_of_ready": str(SOURCE / "READY.json"),
        "replication_of_ready_sha256": sha(SOURCE / "READY.json"),
        "only_intended_changes": ["native seeds", "HF seed", "coordinate IDs", "output identity"],
