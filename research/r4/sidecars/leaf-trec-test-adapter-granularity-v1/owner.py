"""Bounded MAIN-only owner for 148 official-test child calls."""
import argparse
import os
...
def execute(output):
    ...
    try:
        ...
        suite.command(stage, "trec-test148", collector_argv(stage, output / "rollout", work), max(.001, work - time.time()), work)
