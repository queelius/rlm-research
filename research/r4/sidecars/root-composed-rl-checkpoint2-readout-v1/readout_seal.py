...
def build_ready(created_epoch=None):
    campaign=study.read(study.ROOT/"CAMPAIGN_V3.json");decision=study.checkpoint2_decision()
    ...
    return {"schema":"root-composed-rl-checkpoint2-readout-ready-v1",
           ...
           "campaign_sha256":study.sha(study.ROOT/"CAMPAIGN_V3.json"),"checkpoint2":{"policy":decision["policy"],"owner_terminal_sha256":decision["owner_terminal_sha256"],"state_sha256":decision["state_sha256"]},
           "attempt":str(study.ATTEMPT),"gpu_launched":False}
if __name__=="__main__":
    ready=build_ready();study.write(study.ROOT/"READY.json",ready);print(ready["identity"])
