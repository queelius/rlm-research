...
def make_spec(
    ...
    return {
        ...
        "split_provenance": {
            ...
            "limitation": "Source-heldout was evaluated September 2; two contexts only, exploratory reuse.",
        },
        "interpretation": "Task-level supplied procedure benefit under shared coding/recursion system guidance; not free planning.",
        "weight_condition": weight_condition,
        "model_status": "Operator-declared weight condition with frozen model/adapter bytes. Default pre_update step_0 LoRA has zero updates; post_update requires separate descriptor and SPEC.",
        "nano_source": {
...
def summarize(records: list[dict[str, Any]], plan: list[dict[str, Any]]) -> dict[str, Any]:
    ...
    return {
        ...
        "caution": "Two independent context groups, not 56 independent tasks; execution errors are null rewards.",
    }
