...
def build():
    ...
    source_names = [
        "DESIGN.md", "PLAN.md", "RUNBOOK.md", "RECIPE.json", "START.json", "terminal_study.py", "terminal_prepare.py",
        ...
        "GROUP4_QUALIFICATION.json", "test_terminal_rlvr.py", "prepare_campaign.py", "seal.py",
    ]
    ...
    value = {
        "schema": "question-sensitive-terminal-rlvr-campaign-v1",
        "campaign_id": study.CAMPAIGN_ID,
        "question": "Does terminal RL on composed QS tasks strengthen learned task-sensitive routines?",
