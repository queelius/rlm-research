"""V2 collector entrypoint with the complete inherited study contract."""
...
def _load_source():
    ...
    try:
        path = study.ROOT / "collect.py"
        spec = importlib.util.spec_from_file_location("token_tis_held_v1_collect_source", path)
