"""Fresh-context field-order replication bound to the qualified base runtime."""
import contextlib,hashlib,importlib.util,json,sys
from pathlib import Path
ROOT=Path(__file__).resolve().parent;SIDE=ROOT.parent
QUALIFIED=SIDE/'leaf-mnli-new-context-alien-correspondence-v1';SOURCE=SIDE/'leaf-mnli-exact-tag-correspondence-v1';FIELD_ORDER=SIDE/'leaf-mnli-output-field-order-v1'
...
def load(name,path,pin=None,aliases_map=None):
    ...
    return module
qualified=load('field_order_replication_qualified',QUALIFIED/'study.py','58839d48f34d13c623be7ae580dbd0343573a0facc559f33bb1fa4982b0fe138')
