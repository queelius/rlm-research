...
def main():
    ...
    ready=dict(schema='mnli-host-identifier-join-ready-v1',source_sha256=source,input_sha256=inputs,
               model=s.MODEL,adapter=None,planned_endpoints=48,contexts=8,arms=list(p.ARMS),
               factorial='visible_reference3_by_host_join2',seed_master=p.MASTER,
