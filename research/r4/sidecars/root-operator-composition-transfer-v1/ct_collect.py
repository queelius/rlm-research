...
def implementation():
    path=s.OLD/'od_collect.py';module=s.load('composition_original_collector',path,s.read(s.OLD/'READY_v2.json')['source_sha256'][str(path)],{'od_study':s,'od_protocol':s.protocol()})
