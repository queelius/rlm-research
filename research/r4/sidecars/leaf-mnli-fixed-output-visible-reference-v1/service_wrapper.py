...
def qualified_wrapper():
    with s.aliases({'study':s}):wrapper=s.load('fixed_output_visible_reference_service',s.ALIEN/'service_wrapper.py','edd6216899b3c7dc276b885742d29bf9946bac383cd04bee59762cde9e5964b7')
    return wrapper
def main():
