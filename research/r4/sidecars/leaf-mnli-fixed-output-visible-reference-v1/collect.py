...
import sys,types
source=source.replace('8 repeated MNLI contexts; paired seeds are repeated measurements','16 MNLI context clusters; one paired seed per context')
module=types.ModuleType('fixed_output_visible_reference_collector');module.__file__=str(path);sys.modules[module.__name__]=module
