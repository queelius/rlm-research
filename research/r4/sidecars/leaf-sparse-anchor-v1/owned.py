"""Parent-launched single-adapter lifecycle; all edits private and hash-pinned."""
import ast
import hashlib
...
EDITS=[('identity_counter','sparse_anchor',5),('96','144',2),('630','930',1),('600','900',1),('if __name__ == "__main__":','if False:',1)]
...
exec(compile(source,str(SOURCE_PATH)+':sparse144-private','exec'),globals())
